function productViewTrigger() { $('.product-view-trigger').on('click', function (e) {
    var self = $(this),
...
function ImgZoom() {if($('.ex1').length) {$('.ex1').zoom();}}
/* ==============PoPUp=============================== */
function PoPUpInit(){  if ($('.zoom-gallery').length) {
...
/* ============================================= */
function moveNav(){$("<div>", {"class": "owl-controls"}).append($('.owl-nav')).appendTo('.owl-carousel');
     $('.owl-nav .owl-prev span').replaceWith('<span class="fa fa-angle-left" ></span>');
     $('.owl-nav .owl-next span').replaceWith('<span class="fa fa-angle-right"></span>');}
/*===========================================================*/
function selectFun(){
